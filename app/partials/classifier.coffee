...
<div class="classifier row" data-ng-controller="ClassifierCtrl">
  <div class="examples row" ng-class="{'active': getExample()}">
  <div class="col-xs-7 col-centered">
    <div class="row example-selection">
      <p class="col-xs-2">Examples:</p>
      <span class="col-xs-3 example" ng-class="{'active': getExample()=='single-compact-source'}" data-type="single-compact-source">Single Compact Srcs</span>
      ...
      <span class="col-xs-1 exit example" data-type="false">Close</span>
    </div>
  </div>

template = """
  <div class='science' data-ng-controller="ScienceCtrl">
    ...
    <div class="content-block row">
      <div class="col-md-6">
        <h1 class="heading">Why can’t computers match the radio and infrared sources?</h1>
      ...
      <div class="col-md-6">
        <h1 class="heading">How do supermassive black holes form?</h1>
    ...
    <div class="content-block row">
      <div class="col-md-6">
        <h1 class="heading">What effect does a supermassive black hole have on its host galaxy?</h1>
